...
<link src="css/machine.css" rel="stylesheet" type="text/css"></link>
...
<table style="width:100%; class="dimm table table-striped table-bordered table-hover  table-condensed" align='center' border='1' cellspacing='0'>
